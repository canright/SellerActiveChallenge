...
export class FetchDataComponent {
  ...
  public fullForecasts: WeatherForecast[];
  ...
  filterForecasts(filterVal: any) {
    this.forecasts = (filterVal == "0") ? this.fullForecasts : this.fullForecasts.filter((item) => item.summary == filterVal);
  }
